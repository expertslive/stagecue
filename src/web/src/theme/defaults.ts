...
export const tokenSpecs: TokenSpec[] = [
  ...
  { key: "primary", label: "Countdown — above thresholds", value: "#34c759", group: "Brand", description: "Color of the countdown when no threshold is active. Semantic 'all clear'." },
